...
import maptester.NonEmptyTreeException;
 ...
 * @param <T>
 */
public class BSTree<T> implements BinaryTree<T>{
    ...
    public BSTree() throws NonEmptyTreeException{
        nodes = new ArrayList<>();
    }
    ...
    public Position<T> remove(Position<T> v) throws InvalidPositionException {
        //rimozione
        //1 se foglia elimino la coppia
        //2 se ha come figli una foglia w e un nodo interno u elimino w e v e sostituisco u con v
        //3 se ha come figli due nodi interni w e u i due candidati per sostituire v sono il prec e succ. nell'attraversamento in ord simmetrico.
